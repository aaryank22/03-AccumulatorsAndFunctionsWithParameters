...
def draw_circles2():
    ...
    for k in range(18):
        ...
        lucas.pen = rg.Pen('blue', 3)
        lucas.attach_to(xyz)

    xyz.render()
    xyz.close_on_mouse_click()
...
def draw_cosines_and_sines():
    ...
    for k in range(101):
        ...
        hartich = rg.Circle(center, radius)
        hartich.attach_to(alec)

    alec.render()
    alec.close_on_mouse_click()
